...
def _can_manage(u: User):
    """จัดการการจอง = เจ้าของ/ผู้จัดการ/รีเซป (หมอนวด+แคชเชียร์ดูได้อย่างเดียว)"""
    if u.role not in ("Owner", "Manager", "Reception"):
        raise HTTPException(status_code=403, detail="บัญชีนี้ดูการจองได้อย่างเดียว ไม่มีสิทธิ์สร้าง/แก้ไข")
