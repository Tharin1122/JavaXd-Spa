...
# จองล่วงหน้า = สิทธิ์ create บนหน้า bookings/frontdesk (Owner ตั้งได้) | จัดการสถานะ = manage
def _can_manage(db, u):
    require(db, u, "create", ["bookings", "frontdesk"],
            "บัญชีนี้ดูการจองได้อย่างเดียว — เปิดสิทธิ์สร้าง/แก้ที่หน้าสิทธิ์การใช้งาน")
